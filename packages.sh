...
pacman -S steam gamemode gamescope fwupd fwupd-docs sbctl efitools pacman-contrib unrar unzip ufw gwenview firefox openh264 terminus-font evolution evince file-roller
